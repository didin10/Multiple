    ...
    <header class="masthead">
      <div class="container d-flex h-100 align-items-center">
        <div class="mx-auto text-center">
          <h1 class="mx-auto my-0 text-lowercase">Booking Sukses </h1>
          <h2 class="text-white-50 mx-auto mt-2 mb-5">Tunggu sampai Mendapat Balasan Gmail/Whatsapp Dari Kami</h2>

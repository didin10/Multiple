...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
      <div class="container">
        <img src="/img/iya.png">
        <a class="navbar-brand js-scroll-trigger" href="{{ url('/home') }}">Back</a>
    ...
    <header class="masthead">
      <div class="container d-flex h-100 align-items-center">
        <div class="mx-auto text-center">
          <h1 class="mx-auto my-0 text-uppercase">Mengirim Bukti Sukses</h1>
          <h2 class="text-white-50 mx-auto mt-2 mb-5">Selamat Bertanding</h2>
          <div class="flex-center position-ref full-height">
          
           <h3> @Lamongan Futsal Center</h3> 
